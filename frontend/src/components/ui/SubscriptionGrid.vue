        ...
        <div class="panel">
            <div class="gs-bundle-of-buttons" style="max-height:10vh;">
                ...
                <v-btn :disabled="!selectedRow" style="margin-left: 5px;" @click="expireSubscriptionDialog = true" class="contrast-primary-text" small color="primary" :disabled="!hasRole('System')">
                    <v-icon small>mdi-minus-circle-outline</v-icon>구독 만료 처리
                </v-btn>
            ...
            <SubscriptionList @search="search" style="margin-bottom: 10px; background-color: #ffffff;"></SubscriptionList>
            <SubscriptionDetails @search="search" style="margin-bottom: 10px; background-color: #ffffff;"></SubscriptionDetails>
